...
| [017](017-media-storage-signed-urls.md) | Media storage: private bucket + signed URLs | Accepted |
| [018](018-deployment-strategy.md) | Deployment strategy: SSH + single-server (MVP) | Accepted |
